   ...
   return(
      <section className='mt-[200px]'>
         <div className='text-center space-y-[30px]'>
            ...
            <p className='text-secondary font-normal text-2xl leading-[30px] tracking-45 max-w-[1023px] mx-auto'>Senectus et scelerisque convallis at sollicitudin tellus volutpa quam. Viverra placerat morbi ut imperdiet.</p>
         </div>
